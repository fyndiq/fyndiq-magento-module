...
class Fyndiq_Fyndiq_Model_Export
{
            ...
            foreach ($batches as $entityIds) {
                ...
                foreach ($productsToExport as $magProduct) {
                    ...
                    if ($typeId === 'simple') {
                        ...
                        $product = $this->getProduct($store, $magProduct, $productId, $discount, $market, $currency, $stockMin, $priceGroup);
                    ...
                    foreach ($simpleCollection as $simpleProduct) {
                        ...
                        $article = $this->getArticle($store, $simpleProduct, $discount, $productId, $index, $stockMin, $priceGroup);
                        if ($article) {
                            $articles[] = $article;
                        }
                        $index++;
     ...
     * @return array
     */
    private function getProduct($store, $magProduct, $ourProductId, $discount, $market, $currency, $stockMin, $priceGroup)
    {
