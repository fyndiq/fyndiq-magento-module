...
class AdminControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        parent::setUp();
        $this->admincontroller = $this->getMockBuilder('Fyndiq_Fyndiq_AdminController')
    ...
    {
        $this->admincontroller->expects($this->once())->method('getAPIToken')->willReturn('true');
        $this->admincontroller->expects($this->once())->method('getUsername')->willReturn('true');
    ...
    function testSetTemplate()
    {
        ...
        $this->admincontroller->expects($this->once())->method('callAPI')->willReturn(true);
        $return = $this->admincontroller->indexAction(true);
